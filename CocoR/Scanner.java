...
public class Scanner {
	...
	static final int maxT = 83;
	static final int noSym = 83;
	...
	static {
		...
		literals.put("char", new Integer(11));
		...
		literals.put("state", new Integer(24));
		literals.put("init", new Integer(25));
		literals.put("body", new Integer(26));
		literals.put("inherits", new Integer(27));
		literals.put("observes", new Integer(28));
		literals.put("all", new Integer(29));
		literals.put("in", new Integer(30));
		literals.put("var", new Integer(31));
		literals.put("set", new Integer(33));
		literals.put("action", new Integer(36));
		literals.put("affect", new Integer(37));
		literals.put("begin", new Integer(38));
		literals.put("join", new Integer(39));
		literals.put("quit", new Integer(40));
		literals.put("suspend", new Integer(41));
		literals.put("resume", new Integer(42));
		literals.put("create", new Integer(43));
		literals.put("destroy", new Integer(44));
		literals.put("loop", new Integer(45));
		literals.put("while", new Integer(46));
		literals.put("do", new Integer(47));
		literals.put("repeat", new Integer(48));
		literals.put("until", new Integer(49));
		literals.put("for", new Integer(50));
		literals.put("to", new Integer(51));
		literals.put("by", new Integer(52));
		literals.put("forall", new Integer(53));
		literals.put("if", new Integer(54));
		literals.put("then", new Integer(55));
		literals.put("elseif", new Integer(56));
		literals.put("else", new Integer(57));
		literals.put("case", new Integer(58));
		literals.put("with", new Integer(60));
		literals.put("when", new Integer(61));
		literals.put("exist", new Integer(62));
		literals.put("and", new Integer(63));
		literals.put("or", new Integer(64));
		literals.put("xor", new Integer(65));
		literals.put("not", new Integer(77));
		literals.put("true", new Integer(78));
		literals.put("false", new Integer(79));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					...
					else if (ch >= '0' && ch <= '9') {AddCh(); state = 2; break;}
				...
				case 5:
					...
					if (ch == '/' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 5; break;}
					else {t.kind = 3; break loop;}
				case 6:
					if (ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 7; break;}
					else {state = 0; break;}
				case 7:
					if (ch == 39) {AddCh(); state = 8; break;}
					else {state = 0; break;}
				case 8:
					{t.kind = 4; break loop;}
				case 9:
					if (ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); state = 10; break;}
					else {state = 0; break;}
				case 10:
					if (ch == '"') {AddCh(); state = 11; break;}
					else if (ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); state = 10; break;}
					else {state = 0; break;}
				case 11:
					{t.kind = 5; break loop;}
				case 12:
